...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full h-screen flex flex-col md:flex-row bg-cover bg-center bg-fixed overflow-hidden" style={{ backgroundImage: 'url(/images/hero-bg.jpg)' }}>
      ...
      <div className="relative z-10 w-full h-full flex flex-col md:flex-row items-center md:items-start justify-center p-6 md:p-12 lg:p-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center text-center md:text-left">
          {/* Hero Heading */}
          <motion.h1
            className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif text-black-300 mb-4 md:mb-6 relative"
          ...
          <div className="flex flex-col md:flex-row justify-center md:justify-start space-y-4 md:space-y-0 md:space-x-4 mt-6 md:mt-8 lg:mt-10">
            <a
              href="#about"
              className="relative px-4 py-2 md:px-6 md:py-3 bg-green-700 hover:bg-green-800 text-white font-serif rounded-lg shadow-lg transition-transform duration-300 group"
            >
            ...
            <a
              href="#get-started"
              className="relative px-4 py-2 md:px-6 md:py-3 bg-yellow-700 hover:bg-yellow-800 text-white font-serif rounded-lg shadow-lg transition-transform duration-300 group"
            >
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center text-center p-4">
          ...
          <motion.img
            ...
            className="w-full max-w-md md:max-w-lg h-auto rounded-lg shadow-md object-cover mb-4"
